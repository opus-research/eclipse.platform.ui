 ...
 */
public class DnDProcessor extends AbstractProcessor {
	@Execute
	void addDnDAddon(MApplication app, EModelService modelService) {
		final String contributionURI = "bundleclass://org.eclipse.e4.ui.workbench.addons.swt/org.eclipse.e4.ui.workbench.addons.dndaddon.DnDAddon"; //$NON-NLS-1$
		final String id = "DnDAddon"; //$NON-NLS-1$
