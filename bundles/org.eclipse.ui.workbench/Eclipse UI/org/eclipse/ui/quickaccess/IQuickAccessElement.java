...
/**
 * A quick access element represents a specific element accessible through a
 * provider. A view provider, for example, would have every view represented as
 * a quick access element each.
 *
 * @since 3.109
 *
 */
public interface IQuickAccessElement {
	 ...
	 * given filter, returns a {@link QuickAccessMatch}. Otherwise returns
	 * <code>null</code>;
	 *
	 * @param filter
	 *            filter for matching
