...
public interface IWorkingSet extends IPersistableElement, IAdaptable {
	 ...
	 * <p>
	 * This method might throw an {@link IllegalStateException} if the working
	 * set is invalid.
	 * </p>
	 * 
	...
	/**
	 * Returns the working set id. Returns <code>null</code> if no working set
	 * id has been set. This is one of the ids defined by extensions of the
	 * org.eclipse.ui.workingSets extension point. It is used by the workbench
	 * to determine the page to use in the working set edit wizard. The default
	...
	/**
	 * Returns the working set icon. Currently, this is one of the icons
	 * specified in the extensions of the org.eclipse.ui.workingSets extension
	 * point. The extension is identified using the value returned by
	 * <code>getId()</code>. Returns <code>null</code> if no icon has been
	 * specified in the extension or if <code>getId()</code> returns
	 * <code>null</code>.
	 * 
	...
	/**
	 * Sets the name of the working set. The working set name should be unique.
	 * The working set name must not have leading or trailing whitespace.
	 * 
	 * @param name
	...
	/**
	 * Returns whether this working set can be edited or not. To make a working
	 * set editable the attribute <code>pageClass</code> of the extension
	 * defining a working set must be provided.
	 * 
	...
	/**
	 * Return the name of this working set, formated for the end user. Often
	 * this value is the same as the one returned from {@link #getName()}.
	 * 
