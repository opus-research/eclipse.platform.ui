...
public class Throttler {
	 ...
	 * more than {@code minWaitTime}, even if it is {@link #throttledExec()
	 * executed} more often.
	 *
	 * @param display
	...
	/**
	 * Schedule the wrapped runnable to be run after the configured wait time or
	 * do nothing if it has already been scheduled but not executed yet.
	 */
