...
public class InternalDialog extends TrayDialog {
	...
	private StatusAdapter getSingleSelection() {
		IStructuredSelection rawSelection = statusListViewer.getStructuredSelection();
		if (rawSelection != null && rawSelection.size() == 1) {
			return (StatusAdapter) rawSelection.getFirstElement();
		}
		return null;
	}
