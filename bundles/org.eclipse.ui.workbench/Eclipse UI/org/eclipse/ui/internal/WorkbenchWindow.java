...
public class WorkbenchWindow implements IWorkbenchWindow {
	 ...
	 * @since 3.3
	 */
	private ListenerList<IPropertyChangeListener> genericPropertyListeners = new ListenerList<IPropertyChangeListener>();
...
STATUS_LINE_ID, model);
	...
	private ListenerList<IBackgroundSaveListener> backgroundSaveListeners = new ListenerList<IBackgroundSaveListener>(ListenerList.IDENTITY);
	...
	final void addActionSetsListener(final IActionSetsListener listener) {
		if (actionSetListeners == null) {
			actionSetListeners = new ListenerList<IActionSetsListener>();
		}
