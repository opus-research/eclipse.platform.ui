...
public class SearchField {
	...
	void createWidget(final Composite parent, MApplication application, MWindow window) {
		...
		addExtensionProviders(providerList, application, window);
	...
	private void addExtensionProviders(List<IQuickAccessProvider> providers, MApplication application, MWindow window) {
