...
public class WorkbenchMessages extends NLS {
	...
	// --- Import/Export ---
	public static String ImportExportPreferences_title;
	public static String ImportExportPreferences_import;
	public static String ImportExportPreferences_export;
