...
public final class ActivityPatternBindingDefinition {
	...
	private final static int HASH_INITIAL = ActivityPatternBindingDefinition.class.getName()
			.hashCode();
	...
	static Map<String, Collection<ActivityPatternBindingDefinition>> activityPatternBindingDefinitionsByActivityId(
		...
		Map<String, Collection<ActivityPatternBindingDefinition>> map = new HashMap<String, Collection<ActivityPatternBindingDefinition>>();
		Iterator<ActivityPatternBindingDefinition> iterator = activityPatternBindingDefinitions
				.iterator();
		...
		while (iterator.hasNext()) {
			...
			if (activityId != null) {
				Collection<ActivityPatternBindingDefinition> activityPatternBindingDefinitions2 = map
						.get(activityId);
