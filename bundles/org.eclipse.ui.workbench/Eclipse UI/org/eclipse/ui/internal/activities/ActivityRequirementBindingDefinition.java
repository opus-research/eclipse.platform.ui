...
public final class ActivityRequirementBindingDefinition {
	...
	private final static int HASH_INITIAL = ActivityRequirementBindingDefinition.class.getName()
			.hashCode();
	...
	static Map<String, Collection<ActivityRequirementBindingDefinition>> activityRequirementBindingDefinitionsByActivityId(
		...
		Map<String, Collection<ActivityRequirementBindingDefinition>> map = new HashMap<String, Collection<ActivityRequirementBindingDefinition>>();
		Iterator<ActivityRequirementBindingDefinition> iterator = activityRequirementBindingDefinitions
				.iterator();

		while (iterator.hasNext()) {
			ActivityRequirementBindingDefinition activityRequirementBindingDefinition = iterator
					.next();
			...
			if (parentActivityId != null) {
				...
				if (activityRequirementBindingDefinitions2 == null) {
					activityRequirementBindingDefinitions2 = new HashSet<ActivityRequirementBindingDefinition>();
	...
	public ActivityRequirementBindingDefinition(String requiredActivityId, String activityId,
			String sourceId) {
