...
public final class CategoryDefinition implements Comparable {
	...
	static Map<String, CategoryDefinition> categoryDefinitionsById(
			Collection<CategoryDefinition> categoryDefinitions, boolean allowNullIds) {
		if (categoryDefinitions == null) {
			throw new NullPointerException();
		}

		Map<String, CategoryDefinition> map = new HashMap<String, CategoryDefinition>();
	...
	static Map<String, Collection<CategoryDefinition>> categoryDefinitionsByName(
		...
		Map<String, Collection<CategoryDefinition>> map = new HashMap<String, Collection<CategoryDefinition>>();
		Iterator<CategoryDefinition> iterator = categoryDefinitions.iterator();
