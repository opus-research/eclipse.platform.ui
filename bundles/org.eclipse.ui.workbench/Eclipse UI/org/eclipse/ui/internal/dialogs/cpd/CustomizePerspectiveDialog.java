...
public class CustomizePerspectiveDialog extends TrayDialog {
	...
	private void loadMenuAndToolbarStructure() {
		...
		engine.createGui(customizeActionBars.coolBarManager.getTopTrim(), customizeActionBars.windowModel.getWidget(),
				customizeActionBars.windowModel.getContext());
		...
		toolBarItems = createTrimBarEntries(customizeActionBars.coolBarManager.getTopTrim());
