...
public abstract class FilteredPreferenceDialog extends PreferenceDialog
	...
	protected static final Image importImage = WorkbenchImages
			.getImageDescriptor(IWorkbenchGraphicConstants.IMG_ETOOL_IMPORT_WIZ).createImage();

	protected static final Image exportImage = WorkbenchImages
			.getImageDescriptor(IWorkbenchGraphicConstants.IMG_ETOOL_EXPORT_WIZ).createImage();
