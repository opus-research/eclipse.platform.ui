...
/**
 * Bug 501742 - Starting with ~Gnome 3.06, COLOR_INFO_BACKGROUND and
 * COLOR_INFO_FOREGROUND are inverted, often producing windows with black
 * background with white text on an otherwise white background and black text.
 * However, on Windows/Cocoa COLOR_INFO_* looks ok. Solution is to generate a
 * different color based on platform. Note, colors for dark themes are
 * overridden in /org.eclipse.ui.themes/css/dark/e4-dark_preferencestyle.css
 *
 * @since 3.110.0
 *
 */
