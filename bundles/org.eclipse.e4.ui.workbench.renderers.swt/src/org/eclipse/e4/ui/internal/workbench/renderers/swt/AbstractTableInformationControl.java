...
public abstract class AbstractTableInformationControl {
					...
					if (tItem != null) {
						...
						mItem.addSelectionListener(new SelectionAdapter() {
							...
							public void widgetSelected(
								...
								removeSelectedItems(tItem.getData());
							}
						});
	...
	/**
	 * Removes the given selected items from the list and closes their corresponding
	 * tabs. Selects the next item in the list or disposes it if its presentation is
	 * disposed
	 * 
	 * @param selected
	 *            can be {@code null} in this case current selection should be used
	 */
	protected void removeSelectedItems(Object selected) {
