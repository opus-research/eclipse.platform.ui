 ...
 *     Patrik Suzzi <psuzzi@gmail.com> - Bug 461655
 *******************************************************************************/
...
public class MenuManagerRenderer extends SWTPartRenderer {
	...
	private void subscribeTopicChildrenRemoved(@UIEventTopic(ElementContainer.TOPIC_CHILDREN) Event event) {
		...
		// this should work for Inner_Eclipse, check Team and other menus
		...
		if (!list.isEmpty()) {
			for (int i = 0; i < list.size(); i++) {
				...
				if (item instanceof MMenu) {
					...
					// this works for Laura's/Rene's/Andrey's test project
