...
import org.eclipse.e4.ui.di.MatchElement;
...
public interface EModelService {
	...
	/**
	 * This is a convenience method that constructs a new Selector based on {@link MatchElement} and
	 * forwards the call on to the base API
	 * {@link EModelService#findElements(MUIElement, Selector, int)}.
	 * 
	 * @see EModelService#findElements(MUIElement, Selector, int)
	 */
	 ...
	 * @since 1.1
	 */
	public <T> List<T> findElements(MUIElement searchRoot, Selector matcher, int searchFlags);
