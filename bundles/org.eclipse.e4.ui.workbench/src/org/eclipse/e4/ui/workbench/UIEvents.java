...
public class UIEvents {
	...
	public static interface ApplicationElement {
		 ...
		 * @since 1.5
		 */
		public static final String TOPIC_EXPLANATION = "org/eclipse/e4/ui/model/application/ApplicationElement/explanation/*"; //$NON-NLS-1$
		 ...
		 * @since 1.5
		 */
		public static final String EXPLANATION = "explanation"; //$NON-NLS-1$
