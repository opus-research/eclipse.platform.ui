...
public class UIEvents {
	...
	public static interface UILifeCycle {
		...
		/**
		 * Sent when various UIElements are activated. Currently this event is only published for
		 * MPart activations.
		 */
		public static final String ACTIVATE = TOPIC + TOPIC_SEP + "activate"; //$NON-NLS-1$

		/**
		 * Sent when various UIElements are deactivated
		 * 
		 * Note: Currently this is a provisional API reserved for future use...
		 * 
		 * @since 1.1
		 */
		public static final String DEACTIVATE = TOPIC + TOPIC_SEP + "deactivate"; //$NON-NLS-1$

		/**
		 * Sent before various UIElements are rendered.
		 * 
		 * Note: Currently this is a provisional API reserved for future use...
		 * 
		 * @since 1.1
		 */
		public static final String PRE_OPEN = TOPIC + TOPIC_SEP + "preOpen"; //$NON-NLS-1$

		/**
		 * Sent after various UIElements have been completely rendered (including children...)
		 * 
		 * Note: Currently this is a provisional API reserved for future use...
		 * 
		 * @since 1.1
		 */
		public static final String POST_OPEN = TOPIC + TOPIC_SEP + "postOpen"; //$NON-NLS-1$

		/**
		 * Send before various UIElements are unRendered.
		 * 
		 * Note: Currently this is a provisional API reserved for future use...
		 * 
		 * @since 1.1
		 */
		public static final String PRE_CLOSE = TOPIC + TOPIC_SEP + "preClose"; //$NON-NLS-1$

		/**
		 * Sent after various UIElements have been completely unRendered
		 * 
		 * Note: Currently this is a provisional API reserved for future use...
		 * 
		 * @since 1.1
		 */
		public static final String POST_CLOSE = TOPIC + TOPIC_SEP + "postClose"; //$NON-NLS-1$
