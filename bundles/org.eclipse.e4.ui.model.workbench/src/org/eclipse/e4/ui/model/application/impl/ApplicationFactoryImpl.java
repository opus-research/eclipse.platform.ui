...
public class ApplicationFactoryImpl extends EFactoryImpl implements MApplicationFactory {
	 ...
	 * @generated
	 */
	public static final ApplicationFactoryImpl eINSTANCE = init();
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ApplicationPackageImpl.LIFECYCLE_CONTRIBUTION: return (EObject)createLifecycleContribution();
			default:
	 ...
	 * @generated
	 */
	public MLifecycleContribution createLifecycleContribution() {
		LifecycleContributionImpl lifecycleContribution = new LifecycleContributionImpl();
	 ...
	 */
	@Deprecated
	public static ApplicationPackageImpl getPackage() {
		return ApplicationPackageImpl.eINSTANCE;
	}
