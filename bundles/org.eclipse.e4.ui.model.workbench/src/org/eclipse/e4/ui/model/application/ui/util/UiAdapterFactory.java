...
public class UiAdapterFactory extends AdapterFactoryImpl {
	...
	protected UiSwitch<Adapter> modelSwitch =
		new UiSwitch<Adapter>() {
			...
			@Override
			public Adapter caseJavaExpression(MJavaExpression object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.e4.ui.model.application.ui.MJavaExpression <em>Java Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
