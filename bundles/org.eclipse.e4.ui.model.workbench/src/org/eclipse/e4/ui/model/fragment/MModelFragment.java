...
public interface MModelFragment {
	...
	/**
	 * <!-- begin-user-doc --> Merges this MModelFragment into an MApplication.
	 * 
	 * @param application
	 *            The MApplication to merge into. Must not be null.
	 * @return A list of MApplicationElements that were added to the
	 *         MApplication. Must not be null. <!-- end-user-doc --> <!--
	 *         begin-model-doc -->
	 *         <p>
	 *         <strong>Developers</strong>: Add more detailed documentation by
	 *         editing this comment in
	 *         /org.eclipse.e4.ui.model.workbench/model/ModelFragment.ecore.
	 *         There is a GenModel/documentation node under each type and
	 *         attribute.
	 *         </p>
	 *         <!-- end-model-doc -->
	 * @model
