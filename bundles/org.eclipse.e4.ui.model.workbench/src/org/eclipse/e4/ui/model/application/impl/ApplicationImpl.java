 ...
 *   <li>{@link org.eclipse.e4.ui.model.application.impl.ApplicationImpl#getLifeCycleHandler <em>Life Cycle Handler</em>}</li>
...
public class ApplicationImpl extends ElementContainerImpl<MWindow> implements MApplication {
	...
	public List<MLifecycleContribution> getLifeCycleHandler() {
		if (lifeCycleHandler == null) {
			lifeCycleHandler = new EObjectContainmentEList<MLifecycleContribution>(MLifecycleContribution.class, this, ApplicationPackageImpl.APPLICATION__LIFE_CYCLE_HANDLER);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ApplicationPackageImpl.APPLICATION__LIFE_CYCLE_HANDLER:
