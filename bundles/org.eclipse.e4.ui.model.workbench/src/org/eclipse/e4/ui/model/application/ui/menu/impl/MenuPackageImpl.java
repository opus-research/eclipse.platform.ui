...
public class MenuPackageImpl extends EPackageImpl {
	 ...
	 * @ordered
	 */
	public static final int MENU__LIFE_CYCLE_HANDLERS = MENU_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	public static final int POPUP_MENU__LIFE_CYCLE_HANDLERS = MENU__LIFE_CYCLE_HANDLERS;
	 ...
	 * @ordered
	 */
	public static final int RENDERED_MENU__LIFE_CYCLE_HANDLERS = MENU__LIFE_CYCLE_HANDLERS;
	 ...
	 * @ordered
	 */
	public static final int OPAQUE_MENU__LIFE_CYCLE_HANDLERS = MENU__LIFE_CYCLE_HANDLERS;
	...
	public void initializePackageContents() {
		...
		menuEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(theApplicationPackage.getLifecycleAware());
		menuEClass.getEGenericSuperTypes().add(g1);
		g1 = createEGenericType(theUiPackage.getElementContainer());
