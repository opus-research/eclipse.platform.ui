...
public class ApplicationPackageImpl extends EPackageImpl {
	...
	/**
	 * The feature id for the '<em><b>Life Cycle Handlers</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	public static final int APPLICATION__LIFE_CYCLE_HANDLERS = UiPackageImpl.ELEMENT_CONTAINER_FEATURE_COUNT + 12;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link org.eclipse.e4.ui.model.application.MLifecycleAware#getLifeCycleHandlers <em>Life Cycle Handlers</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Life Cycle Handlers</em>'.
	 * @see org.eclipse.e4.ui.model.application.MLifecycleAware#getLifeCycleHandlers()
	...
	public void createPackageContents() {
		...
		createEReference(lifecycleAwareEClass, LIFECYCLE_AWARE__LIFE_CYCLE_HANDLERS);
	...
	public void initializePackageContents() {
		...
		initEReference(getLifecycleAware_LifeCycleHandlers(), this.getLifecycleContribution(), null, "lifeCycleHandlers", null, 0, -1, MLifecycleAware.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
	...
	public interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Life Cycle Handlers</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		public static final EReference LIFECYCLE_AWARE__LIFE_CYCLE_HANDLERS = eINSTANCE.getLifecycleAware_LifeCycleHandlers();
