...
public abstract class SelectionDialog<T> extends TrayDialog {
	...
	// canceled
	private Collection<T> userSelection;
	 ...
	 *         was set
	 */
	public Collection<T> getUserSelection() {
	 ...
	 *            pressed
	 */
	protected void setUserSelection(Set<T> newUserSelection) {
		if (newUserSelection == null) {
			userSelection = Collections.emptySet();
		} else {
	 ...
	 *            - the new values
	 */
	protected void setUserSelection(T... newUserSelection) {
		if (newUserSelection == null) {
			userSelection = Collections.emptyList();
		} else {
			userSelection = Arrays.asList(newUserSelection);
		}
	}
