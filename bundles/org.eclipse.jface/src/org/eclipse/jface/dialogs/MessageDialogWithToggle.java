...
public class MessageDialogWithToggle extends MessageDialog {
	 ...
	 * Integer> to set custom button labels (String) and custom button ids
	 * (Integer) as return codes for that buttons.
	 *
	 * @param parentShell
	 *            the parent shell
	 * @param dialogTitle
	 ...
	 *            map with button labels and ids to define custom labels and their corresponding ids
	 * @param defaultIndex
	 *            the index in the button label array of the default button
	 * @param toggleMessage
	 *            the message for the toggle control, or <code>null</code> for
