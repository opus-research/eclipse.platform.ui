...
public abstract class Wizard implements IWizard {
	 ...
	 * hide the button labeled "Help".
	 * </p>
	 * <p>
	 * <strong>Note:</strong> This wizard's container might be a
	 * {@link TrayDialog} which provides its own help support that is
	 * independent of this property.
	 * </p>
	 * <p>
	 * <strong>Note 2:</strong> In the default {@link WizardDialog}
	 * implementation, the "Help" button only works when
	 * {@link org.eclipse.jface.dialogs.IDialogPage#performHelp()} is
	 * implemented.
	 * </p>
	 * 
	 * @param b
	 *            <code>true</code> if help is available, <code>false</code>
	 *            otherwise
	 * @see #isHelpAvailable()
