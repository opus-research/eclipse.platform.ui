...
public interface ITreeContentProvider extends IStructuredContentProvider {
	 ...
	 * @param parentElement
	 *            the parent element
	 * @return an array of child elements. The default defined by this interface
	 *         is an empty object array.
	 */
	 ...
	 *         parent cannot be computed. The default defined by this interface
	 *         is null.
	 */
	 ...
	 *         <code>false</code> if it has no children. The default defined by
	 *         this interface is <code>false</code>.
	 */
