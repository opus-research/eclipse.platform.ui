...
public class CheckboxTableViewer<E, I> extends TableViewer<E, I> implements ICheckable<E> {
	 ...
	 * <code>SWT.CHECK</code> and <code>SWT.BORDER</code>. The table has one
	 ...
	 * <p>
	 * This also adds a <code>TableColumn</code> for the single column, and sets
	 * a <code>TableLayout</code> on the table which sizes the column to fill
	 ...
	 * SWT correctly handles the initial sizing and subsequent resizes in this
	 * case.
	 *
	 * @param parent
	 *            the parent control
	 ...
	 * <code>SWT.CHECK</code> style bit must be set on the given table control.
	 ...
	 * viewer. Does not fire events to check state listeners.
	 *
	 * @param state
	 ...
	 *
	 * @param state
	 *            <code>true</code> if the element should be grayed, and
	 ...
	 *
	 * @param elements
	 *            the list of checked elements (element type:
	 *            <code>Object</code>)
