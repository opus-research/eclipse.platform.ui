 ...
 * @param <I> Type of an element of the model
 */
public interface ILabelProvider<I> extends IBaseLabelProvider<I> {
    /**
     ...
     */
    public Image getImage(I element);
     ...
     */
    public String getText(I element);
}
