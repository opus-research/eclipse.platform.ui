...
public interface ISideEffectFactory {
	 ...
	 * <p>
	 * Callers that supply a {@link Consumer} which manages the lifecycle of the
	 * {@link ISideEffect}s should document how they will be managed and what
	 * the responsibilities of the caller are with respect to disposal.
	 *
	 ...
	 * not run it immediately.
	 * <p>
	 * Callers should refer to the JavaDoc for the method they obtained their
	 * factory instance from to determine if they are responsible for disposing
	 * the returned {@link ISideEffect}. Some factory instances will take care
	 * of disposal automatically and others will pass this responsibility onto
	 * the caller. The caller must obey the contracts for the factory they are
	 * using.
	 *
	 * @param runnable
	 ...
	 *         result if they wish to dispose it early. Certain factory
	 *         instances may require all callers to do so.
	 */
	 ...
	 *         dispose it early. Certain factory instances may require all
	 *         callers to do so.
	 */
