...
public class MultiList<E> extends AbstractObservableList<E> {
	...
	private List<ListDiffEntry<E>> offsetListDiffEntries(int offset, List<ListDiffEntry<E>> entries) {
		List<ListDiffEntry<E>> offsetEntries = new ArrayList<ListDiffEntry<E>>(entries.size());
	...
	private ListDiffEntry<E> offsetListDiffEntry(int offset, ListDiffEntry<E> entry) {
