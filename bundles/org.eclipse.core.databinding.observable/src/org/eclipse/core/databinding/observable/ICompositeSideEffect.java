...
public interface ICompositeSideEffect extends ISideEffect {
	...
	/**
	 * This {@link Consumer} is supposed to be passed to an
	 * {@link ISideEffectFactory}, so that this composite can be filled
	 * automatically by the factory.
	 *
	 * @return Consumer<ISideEffect> and never <code>null</code>
	 */
	Consumer<ISideEffect> getSideEffectConsumer();
