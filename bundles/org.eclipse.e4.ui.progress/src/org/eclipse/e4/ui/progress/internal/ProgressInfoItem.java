...
public class ProgressInfoItem extends Composite {
	...
	static {
		JFaceResources
				...
				.put(
						STOP_IMAGE_KEY,
						getImageDescriptor("elcl16/progress_stop.png"));//$NON-NLS-1$

		JFaceResources
				.getImageRegistry()
				.put(
						DISABLED_STOP_IMAGE_KEY,
		        		getImageDescriptor("dlcl16/progress_stop.png"));//$NON-NLS-1$

		JFaceResources
				.getImageRegistry()
				.put(
						DEFAULT_JOB_KEY,
		        		getImageDescriptor("progress/progress_task.png")); //$NON-NLS-1$

		JFaceResources
				.getImageRegistry()
				.put(
						CLEAR_FINISHED_JOB_KEY,
						getImageDescriptor("elcl16/progress_rem.png")); //$NON-NLS-1$

		JFaceResources
				.getImageRegistry()
				.put(
						DISABLED_CLEAR_FINISHED_JOB_KEY,
		        		getImageDescriptor("dlcl16/progress_rem.png")); //$NON-NLS-1$
