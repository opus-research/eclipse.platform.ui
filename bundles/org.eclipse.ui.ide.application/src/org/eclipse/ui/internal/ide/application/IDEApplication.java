...
public class IDEApplication implements IApplication, IExecutableExtension {
    ...
    // Use the branding plugin of the platform feature since this is most likely
    // to change on an update of the IDE.
    private static final String WORKSPACE_VERSION_REFERENCE_BUNDLE = "org.eclipse.platform"; //$NON-NLS-1$

    private static final String WORKSPACE_VERSION_REFERENCE_BUNDLE_LEGACY = "org.eclipse.core.runtime"; //$NON-NLS-1$
    private static final int WORKSPACE_VERSION_LEGACY = 1;
    ...
    private boolean checkValidWorkspace(Shell shell, URL url) {
        ...
        final Version ide_version = toMajorMinorVersion(Platform.getBundle(WORKSPACE_VERSION_REFERENCE_BUNDLE).getVersion());
    ...
    private static void writeWorkspaceVersion() {
        ...
        Bundle bundle = Platform.getBundle(WORKSPACE_VERSION_REFERENCE_BUNDLE);
