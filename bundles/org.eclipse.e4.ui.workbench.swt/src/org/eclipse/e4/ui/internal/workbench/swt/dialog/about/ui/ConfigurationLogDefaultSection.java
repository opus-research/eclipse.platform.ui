...
public class ConfigurationLogDefaultSection implements ISystemSummarySection {
	...
	private void appendProperties(PrintWriter writer) {
		writer.println();
		writer.println(WorkbenchSWTMessages.SystemSummary_systemProperties);
	...
	private void appendFeatures(PrintWriter writer) {
		writer.println();
		writer.println(WorkbenchSWTMessages.SystemSummary_features);
		...
		for (int i = 0; i < bundleGroupInfos.length; ++i) {
			...
			writer.println(NLS.bind(WorkbenchSWTMessages.SystemSummary_featureVersion, args));
		}
	}
	...
	private void appendRegistry(PrintWriter writer) {
		writer.println();
		writer.println(WorkbenchSWTMessages.SystemSummary_pluginRegistry);
		...
		for (int i = 0; i < bundleInfos.length; ++i) {
			...
			writer.println(NLS.bind(WorkbenchSWTMessages.SystemSummary_descriptorIdVersionState, args));
		}
	}
	...
	private void appendUserPreferences(PrintWriter writer) {
		...
		writer.println();
		writer.println(WorkbenchSWTMessages.SystemSummary_userPreferences);
