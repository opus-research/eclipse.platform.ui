...
public class SaveablesLifecycleEvent extends EventObject {
	...
	/**
	 * Eventimport java.util.EventObject;
 the given saveables are about to be
	...
	/**
	 * Event type constant specifying that the dirty state of the given
	 * saveables has changed.
	 */
	 ...
	 * 
	 * @param source
	 *            The source of the event. If an ISaveablesSource notifies about
	 *            changes to the saveables returned by
