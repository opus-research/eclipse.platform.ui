...
public class EvaluationValueReference extends SoftReference {
	...
	/**
	 * Clears this reference and the underlying key reference.
	 *
	...
	private static String toStringArrayAware(Object o) {
		...
		if (o instanceof Object[]) {
			...
			// Arrays#asList(Object[]).toString() is the next best thing.
			// Print at most 10 elements.
			int maxElements = Math.min(((Object[]) o).length, 10);
			return java.util.Arrays.asList((Object[]) o).subList(0, maxElements).toString();
		}
