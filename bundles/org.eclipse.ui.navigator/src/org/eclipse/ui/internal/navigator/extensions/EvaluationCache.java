...
public class EvaluationCache implements VisibilityListener {
	...
	// TODO Have an LRU cache with max size as well as SoftReferences, to help prevent pathological GC performance
	...
	// their data structures OR not bother tracking "overrides or not" state
	// here and instead let users of this class handle it with two instances of
	// this class.
