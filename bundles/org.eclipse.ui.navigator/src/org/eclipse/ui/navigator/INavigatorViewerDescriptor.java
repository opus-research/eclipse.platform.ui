...
public interface INavigatorViewerDescriptor {
	 ...
	 * "Customize Project Explorer" dialog should not be available for the user
	...
	/**
	 * {@value} (boolean): True indicates the entire "Customize Project
	 * Explorer" dialog should not be available for the user (defaults to
	 * <b>false</b>).
	 */
