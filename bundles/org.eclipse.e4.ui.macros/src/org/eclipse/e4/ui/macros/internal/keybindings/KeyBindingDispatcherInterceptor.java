...
public class KeyBindingDispatcherInterceptor implements IKeyBindingInterceptor {
	 ...
	 *            the eclipse context.
	 */
	public KeyBindingDispatcherInterceptor(EMacroContextService macroContext, EAcceptedCommands acceptedCommands,
	...
	public boolean executeCommand(ParameterizedCommand cmd, Event event) {
		...
		// System.out.println("Command not whitelisted in macro: " + cmd.getId()); //$NON-NLS-1$
		return true;
	}
}
