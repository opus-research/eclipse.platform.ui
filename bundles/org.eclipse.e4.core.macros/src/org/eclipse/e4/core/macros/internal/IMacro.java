...
/* default */ interface IMacro {
	 ...
	 *            maps a command id to an implementation which is able to create
	 *            a macro from its persisted state.
	 */
	void setCommandIdToFactory(Map<String, IMacroCommandFactory> commandIdToFactory);
