...
public class MacroManager {
	...
	public void playbackLastMacro(EMacroContext macroContext, final IMacroPlaybackContext macroPlaybackContext,
			final Map<String, IMacroCommandCreator> commandIdToCreator) {
	...
	public IMacroContextListener[] getMacroListeners() {
		...
		IMacroContextListener[] macroListeners = new IMacroContextListener[listeners.length];
		System.arraycopy(listeners, 0, macroListeners, 0, listeners.length);
		return macroListeners;
	}
