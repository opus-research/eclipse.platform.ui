...
/**
 * The basic abstraction of a macro command (i.e.: a macro may be composed of
 * multiple macro commands and it may be stored in disk to be reconstructed
 * later on).
 */
public interface IMacroCommand {
	 ...
	 * {@link org.eclipse.e4.core.macros.IMacroCommandFactory} registered through the
	 * org.eclipse.e4.core.macros.macroCommandsFactory extension point.
	 *
