 ...
 * also needs to have an {@link IMacroCommandCreator} registered through the
 * org.eclipse.e4.core.macros.macroCommandCreators extension point (with a match
...
public interface EMacroContext {
	 ...
	 * command also needs to have an {@link IMacroCommandCreator} registered through
	 * the org.eclipse.e4.core.macros.macroCommandCreators extension point (with a
