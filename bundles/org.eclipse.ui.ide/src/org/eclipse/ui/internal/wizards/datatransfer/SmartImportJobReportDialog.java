...
public class SmartImportJobReportDialog extends Dialog {
	...
	public SmartImportJobReportDialog(Shell shell, SmartImportJob job) {
		...
		jobChangeListener = new IJobChangeListener() {
			...
			public void done(final IJobChangeEvent jobEvent) {
				if (jobEvent.getJob() == SmartImportJobReportDialog.this.job && getShell() != null) {
	...
	public Composite createDialogArea(Composite parent) {
		...
		progressBar = new ProgressBar(progressComposite, SWT.SMOOTH | SWT.INDETERMINATE);
		progressBar.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));
		progressBar.setToolTipText(DataTransferMessages.SmartImportReport_progressBarTooltip);
		...
		stopButton = new Button(res, SWT.PUSH);
