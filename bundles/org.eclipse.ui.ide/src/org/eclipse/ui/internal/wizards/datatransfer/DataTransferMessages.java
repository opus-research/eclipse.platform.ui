...
public class DataTransferMessages extends NLS {
	...
	public static String SmartImpprtProposals_areadyImportedAsProject_description;
	...
	public static String SmartImportJob_importProject;

	public static String SmartImportJob_eclipseProjectConfigurationLabel;
	...
	public static String SmartImportProposals_preliminaryDetection_Title;
	public static String SmartImportProposals_preliminaryDetection_Description;
	...
	public static String SmartImportJob_didntFindImportProposals_title;
	public static String SmartImportJob_didntFindImportProposals_message;
	...
	public static String SmartImportReport_progressBarTooltip;
	...
	public static String SmartImportReport_completed;
	public static String SmartImportReport_aborted;
	...
	public static String SmartImportProposals_additionalAnalysis;
	public static String SmartImportJob_sorry;
	public static String SmartImportJob_internalError;

	public static String SmartImportWizardPage_expandingArchive;
	public static String SmartImportWizardPage_deletingDirectory;
