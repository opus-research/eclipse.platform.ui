...
public class DataTransferMessages extends NLS {
	...
	public static String EasymportWizardPage_allSupportedArchives;
	public static String importReport_completed;
	public static String importReport_aborted;
	public static String EasymportWizardPage_selectArchiveButton;
	public static String EasymportWizardPage_selectArchiveTitle;
	...
	public static String expandingArchive;
