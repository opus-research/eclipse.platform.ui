...
public class ProjectNaturesPage extends PropertyPage {
	...
	protected Control createContents(final Composite parent) {
		...
		this.activeNaturesList = new TableViewer(composite);
		...
		addButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (!ProjectNaturesPage.this.warningAlreadyShown) {
					if (!MessageDialog.openConfirm(getShell(), IDEWorkbenchMessages.ProjectNaturesPage_changeWarningTitle, IDEWorkbenchMessages.ProjectNaturesPage_changeWarningMessage)) {
						return;
					}
