...
public final class WorkbenchActionBuilder extends ActionBarAdvisor {
	...
	protected void makeActions(final IWorkbenchWindow window) {
		...
		if (Util.isCocoa()) {
			...
			CommandContributionItemParameter minimizeParam = new CommandContributionItemParameter(
					window,
					null,
			...
			CommandContributionItemParameter zoomParam = new CommandContributionItemParameter(
					window,
					null,
