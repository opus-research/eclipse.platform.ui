...
public class CSSSWTFontHelper {
	private static final String FONT_DEFINITION_MARKER = "#";	
	
	private static final String VALUE_FROM_FONT_DEFINITION = "default";
	...
	public static FontData getFontData(CSS2FontProperties fontProperties,
		...
		boolean fontFamilySet = newFontData.getName() != null && !newFontData.getName().trim().isEmpty();
