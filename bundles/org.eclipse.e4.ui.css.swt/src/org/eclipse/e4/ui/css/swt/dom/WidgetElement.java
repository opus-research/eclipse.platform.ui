...
public class WidgetElement extends ElementAdapter implements NodeList {
	 ...
	 * <ul>
	 * <li>The method shall only be a lookup for a supplier no actual computation
	 * shall be made.
	 * <li>The result of the supplier must hold the requirements of the result of
	 * {@link #getAttribute(String)}. Especially it <strong>must not</strong>
	 * return {@code null}.
	 ...
	 * @return a supplier which will return the actual attribute value or null
