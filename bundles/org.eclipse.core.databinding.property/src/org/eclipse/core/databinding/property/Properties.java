/*******************************************************************************
 * Copyright (c) 2008, 2009, 2015 Matthew Hall and others.
...
public class Properties {
	 ...
	 */
	public static <S, E> IObservableMap<?, ?>[] observeEach(IObservableSet<E> domainSet,
	 ...
	 * @since 1.5
	 */
	public static <S, E> IObservableMap<?, ?>[] observeEach(IObservableMap<?, E> domainMap,
			IValueProperty<? super E, ?>[] properties) {
		IObservableMap<?, ?>[] maps = new IObservableMap[properties.length];
		for (int i = 0; i < maps.length; i++)
