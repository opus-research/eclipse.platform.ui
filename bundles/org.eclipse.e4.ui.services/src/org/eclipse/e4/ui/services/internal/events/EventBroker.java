...
public class EventBroker implements IEventBroker {
	...
	public boolean send(String topic, Object data) {
		...
		if (activator == null) {
			if (logger != null) {
				logger.error(ServiceMessages.getMessage(ServiceMessages.NO_EVENT_ADMIN, event.toString()));
			}
			return false;
		}
	...
	public boolean subscribe(String topic, String filter, EventHandler eventHandler, boolean headless) {
		...
		if (bundleContext == null) {
			if (logger != null) {
				logger.error(ServiceMessages.getMessage(ServiceMessages.NO_BUNDLE_CONTEXT, topic));
			}
			return false;
		}
