...
public class TestTableWrapLayout {
	...
	public void setUp() {
		...
		inner = new Composite(shell, SWT.V_SCROLL);
	...
	public void testTableWrapLayoutNonWrappingLabels() {
		Control l1 = ControlFactory.create(inner, 100, 100, 15);
		Control l2 = ControlFactory.create(inner, 800, 800, 15);
		inner.pack();
	...
	public void suppressed_testTableWrapLayoutAlignment() {
		TableWrapLayout tableWrapLayout = layout;
