...
public class ZoomAndPreferencesFontTestCase {
	 ...
	 * @param testName
	 */
	public ZoomAndPreferencesFontTestCase() {
	}

	@BeforeClass
	public static void createFilesAndOpenEditor() throws Exception {
		project = ResourcesPlugin.getWorkspace().getRoot()
				.getProject(ZoomAndPreferencesFontTestCase.class.getSimpleName()); // $NON-NLS-1$
		project.create(new NullProgressMonitor());
		project.open(new NullProgressMonitor());
		file = project.getFile(ZoomAndPreferencesFontTestCase.class.getSimpleName());
		file.create(new ByteArrayInputStream(ZoomAndPreferencesFontTestCase.class.getSimpleName().getBytes()), true,
