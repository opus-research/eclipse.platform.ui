...
/**
 * This testcase for Bug 242231 checks that applyEditorValue(), which has been made into a public method,
 * works as advertised, namely that it closes an open cell editor and sets its value to the model.
 * 
 * @since 3.5
 */
public class Bug242231Test extends ViewerTestCase {
	 ...
	 * 
	 * @see
	 * org.eclipse.jface.tests.viewers.ViewerTestCase#createViewer(org.eclipse
