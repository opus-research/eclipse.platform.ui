...
/**
 * This is the generic version of the ViewerTestCase class.
 * The input type and the element type for this viewer are both TestElement
 * @see org.eclipse.jface.tests.viewers.ViewerTestCase
 */
public abstract class ViewerGenericsTestCase extends TestCase {
	...
	public ViewerGenericsTestCase(String name) {
		super(name);
