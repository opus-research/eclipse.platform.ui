...
public class MacroTest {
	...
	public void testAddMacroCommands() throws Exception {
		...
		MacroManager macroManager = new MacroManager();
		Map<String, IMacroCommandCreator> commandIdToCreator = makeCommandIdToCreator();
	...
	protected void createMacroWithOneDummyCommand(MacroManager macroManager,
			Map<String, IMacroCommandCreator> commandIdToCreator) {
		macroManager.toggleMacroRecord(null, commandIdToCreator);
		macroManager.addMacroCommand(new DummyMacroCommand("macro1"));
		macroManager.toggleMacroRecord(null, commandIdToCreator);
	}

	private Map<String, IMacroCommandCreator> makeCommandIdToCreator() {
		Map<String, IMacroCommandCreator> commandIdToCreator = new HashMap<>();
		commandIdToCreator.put("dummy", new IMacroCommandCreator() {
