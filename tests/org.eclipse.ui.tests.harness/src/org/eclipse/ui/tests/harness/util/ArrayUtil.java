...
/**
 * <code>ArrayUtil</code> contains methods for array examination.
 */
public class ArrayUtil {
	...
	/**
	 * Returns whether an array is not null and each object in the array is not
	 * null.
	 *
	 * @param array
	 *            the input array
	...
	/**
	 * Returns whether two arrays are equal. They must have the same size and
	 * the same contents.
	 *
	 * @param one
	 *            the first array
	 * @param two
	 *            the second array
	 * @return <code>true</code> if the array are equal, <code>false</code>
	 *         otherwise.
	 */
