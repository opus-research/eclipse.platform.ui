...
public class ModelAssemblerTests {
	...
	public void testFragments_emptyFragment() throws Exception {
		...
		List<MApplicationElement> elements = assembler.processFragment(fragment, contributorURI, true);
	...
	public void testFragments_workingFragment() throws Exception {
		...
		final String contributorURI = "testFragments_emptyFragment_contribURI";
		List<MApplicationElement> elements = assembler.processFragment(fragment, contributorURI, false);
		...
		assertEquals(found.getParent().getElementId(), "org.eclipse.e4.ui.tests.modelassembler.app");
	...
	public void testFragments_existingXMIID_checkExists() throws Exception {
		...
		List<MApplicationElement> elements = assembler.processFragment(fragment,
				"testFragments_existingElementID_contribURI", true);
	...
	public void testFragments_existingXMIID_ignoreExists() throws Exception {
		...
		List<MApplicationElement> elements = assembler.processFragment(fragment, contributorID, false);
	...
	private void testProcessor(String filePath, boolean initial, boolean afterFragments) throws Exception {
		...
		IExtensionRegistry registry = getTestExtensionRegistry();
	...
	private IExtensionRegistry getTestExtensionRegistry() {
