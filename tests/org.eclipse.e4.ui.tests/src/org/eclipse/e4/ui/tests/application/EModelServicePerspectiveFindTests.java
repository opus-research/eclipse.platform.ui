...
public class EModelServicePerspectiveFindTests extends TestCase {
	@Parameters
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] { { true }, { false } });
	}

	// Whether to create simple app setup or traditional setup
	...
	public EModelServicePerspectiveFindTests(boolean simple) {
		this.simple = simple;
		setName(simple ? "simple setup" : "compat layer setup");
	}
