...
public class PartOnTopManagerTest {
	...
	public void test_PartOnTop() {
		...
		Object onTop = part.getContext().get(IWorkbench.ON_TOP);

		assertTrue(Boolean.TRUE.equals(onTop));
	}
	...
	public void test_PartOnTopStackSwitch() {
		...
		Object partOnTop = part.getContext().get(IWorkbench.ON_TOP);
		Object secondPartOnTop = secondPart.getContext().get(IWorkbench.ON_TOP);

		assertTrue(Boolean.TRUE.equals(partOnTop));
		assertTrue(Boolean.FALSE.equals(secondPartOnTop));

		partStack.setSelectedElement(secondPart);

		assertTrue(Boolean.FALSE.equals(partOnTop));
		assertTrue(Boolean.TRUE.equals(secondPartOnTop));
	}
	...
	public void test_PartOnTopPerspectiveSwitch() {
		...
		assertTrue(Boolean.TRUE.equals(secondPerspectivePart));
	}
}
