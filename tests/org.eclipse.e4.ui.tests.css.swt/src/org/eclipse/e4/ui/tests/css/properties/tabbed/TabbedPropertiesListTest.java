...
public class TabbedPropertiesListTest extends CSSSWTTestCase {
	...
	private TabbedPropertyList createTabbedPropertiesList(String stylesheet) {
		String s;
		if (stylesheet == null) {
			s = "TabbedPropertyList { listBackground-color: #FF0000; widgetBackground-color: #FF0000; widgetNormalShadow-color: #FF0000; widgetDarkShadow-color: #FF0000; widgetForeground-color: #FF0000;}";
		} else {
			s = stylesheet;
		}
