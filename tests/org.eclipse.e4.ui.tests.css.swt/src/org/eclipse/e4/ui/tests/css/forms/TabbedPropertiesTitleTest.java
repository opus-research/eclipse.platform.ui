...
public class TabbedPropertiesTitleTest extends CSSSWTTestCase {
	...
	private TabbedPropertyTitle createTabbedPropertiesTitle() {
		engine = createEngine(
				"TabbedPropertyTitle { h-gradient-start-color: #FF0000; h-gradient-end-color: #FF0000; h-bottom-keyline-1-color: #FF0000; h-bottom-keyline-2-color: #FF0000;}",
				display);
