...
public class EventLoopMonitorThreadManualJUnitPluginTests extends TestCase {
	/** Print out test information to console. **/
	...
	protected static final double MAX_RELATIVE_INCREASE_ONE_STACK = 2.5; // %

	/** Maximum allowable relative increase due to taking traces on all threads. */
	protected static final double MAX_RELATIVE_INCREASE_ALL_STACKS_PER_THREAD = 0.25; // %
	...
	public void testFixedWork() throws Exception {
		...
		double maxRelativeIncreaseAllStacksAllowed =
			(MAX_RELATIVE_INCREASE_ALL_STACKS_PER_THREAD * totalThreadCount / 100) * (1 + controlDiff);
