 ...
 *
 */
public class SnippetSideEffektTwoWayBinding {
	...
	static class View {
		...
		private void bindData() {
			...
			ISideEffect modelToTarget = SideEffect.create(() -> (String) taskNameObservable.getValue(),
					summaryText::setText);
			ISideEffect targetToModel = SideEffect.create(() -> (String) textModifyObservable.getValue(),
					task::setSummary);
