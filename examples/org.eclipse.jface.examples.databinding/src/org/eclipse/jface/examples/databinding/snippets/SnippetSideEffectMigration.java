...
import org.eclipse.jface.databinding.observable.WidgetSideEffectFactory;
...
public class SnippetSideEffectMigration {
	...
	static class TrackedView {
		...
		private void bindData() {
			...
			ICompositeSideEffect sideEffectContext = WidgetSideEffectFactory
					.createCompositeSideEffect(personFirstNameText);
			ISideEffectFactory sideEffectFactory = ISideEffectFactory.create(sideEffectContext);
