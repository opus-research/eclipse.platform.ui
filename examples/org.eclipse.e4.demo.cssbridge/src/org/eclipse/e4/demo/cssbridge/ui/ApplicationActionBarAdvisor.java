...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void makeActions(final IWorkbenchWindow window) {
		...
		switchToThemeActions[0] = new CssThemeSwitchAction(SWITCH_TO_EMPTY_CSS_THEME, "Switch to the 'Empty' CSS theme where the CSS styling is disabled",
				"/icons/empty_theme.png", CSSTheme.EMPTY_THEME_ID, window);
		register(switchToThemeActions[0]);

		switchToThemeActions[1] = new CssThemeSwitchAction(SWITCH_TO_BLUE_CSS_THEME, "Switch to the 'Blue' CSS theme",
				"/icons/blue_theme.png", CSSTheme.BLUE_THEME_ID, window);
		register(switchToThemeActions[1]);

		switchToThemeActions[2] = new CssThemeSwitchAction(SWITCH_TO_GREEN_CSS_THEME, "Switch to the 'Green' CSS theme",
				"/icons/green_theme.png", CSSTheme.GREEN_THEME_ID, window);
		register(switchToThemeActions[2]);

		switchToThemeActions[3] = new CssThemeSwitchAction(SWITCH_TO_RED_CSS_THEME, "Switch to the 'Red' CSS theme",
