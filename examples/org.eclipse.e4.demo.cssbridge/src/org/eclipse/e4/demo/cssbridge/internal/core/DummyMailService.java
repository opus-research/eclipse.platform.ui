...
public class DummyMailService implements IMailService {
	...
	private List<Mail> createDummyInboxFolderMails() {
		return new ArrayList<Mail>() {{
			...
			add(mailBuilder.mail()
					.withImportance(Importance.High)
					.withDate(parse("2013-02-11 10:12"))
					.withSender("admin")
					.withSubject("Power outage")
					.withBody("We got the information about the power outage during the incoming weekend. Please check your UPS devices")
					.create());
			...
			add(mailBuilder.mail()
					...
					.withSubject("This is a message about the cool Eclipse RCP!")
					.withBody("This RCP Application was generated from the PDE Plug-in Project wizard. This sample shows how to:\n" +
	...
	private List<Mail> createDummySentFolderMails() {
		return new ArrayList<Mail>() {{
			...
			add(mailBuilder.mail()
					.withImportance(Importance.High)
					.withDate(parse("2013-02-12 10:00"))
					.withSender("me")
					.withSubject("Re: Power outage")
					.withBody("Done")
					.create());
