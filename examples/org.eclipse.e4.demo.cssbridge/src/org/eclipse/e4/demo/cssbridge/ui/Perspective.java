...
public class Perspective implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		layout.addStandaloneView(FoldersView.ID,  false, IPageLayout.LEFT, 0.25f, editorArea);
		layout.addStandaloneView(FolderPreviewView.ID,  false, IPageLayout.RIGHT, 0.5f, editorArea);
